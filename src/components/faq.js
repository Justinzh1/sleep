export default {
	faq: [
		{ 
				...
				awake increases and vice-versa. Whereas the longer awake, the more pressure there is to sleep, \
		...
		{ 
				...
				asked: 1,
				answer: "Insomnia can be caused by a variety of psychiatric and medical conditions such as \
				unhealthy sleep habits, substances, and/or biological factors. Recent studies have \
				suggested that insomnia is a result of your brain being unable \
				to stop being awake."
		},
		{ 		
				question: "What is the recommended number of hours of sleep per age group?",
				asked: 1,
		...
		{ 
				...
				asked: 1,
				answer: "Sleep is not cumulative as we can't make up all the sleep we may lose pulling \
				all-nighters or any lack of sleep for several hours. You may not recover all the sleep you lose and \
				remain in a sleep deficit for several days. However, even if a loss of sleep happens, the body has its own recovery \
				system that makes it easier to bounce back from a lack of rest."
		},
		{ 
		...
		{ 
				question: "Is it healthy to pull all nighters?",
				asked: 1,
				...
				health problems, psychosis and possibly death. To put this in persepctive, the World Health Organization currently \
				recognizes sleep deprivation as a carcinogen."
		},
		{ 
		...
		{ 
				...
				therapy. By dreaming we dissolve the emotional trauma of certain events we encounter. Evidence to support this \
				theory comes from the discovered correlation between sufferers of PTSD and their ability, or lack thereof, of dreaming."
		},
		{ 
